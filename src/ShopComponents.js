  ...
  return (
    <>
      ...
      <div className="sortAllButtons">
        ...
        <Button className="sortButtonReverse" onClick={handleSortReverse}>
          Sort Z-A
        </Button>
        <Button className="sortButtonById" onClick={handleSortById}>
          Sort By ID ↓
        </Button>
        <Button className="sortButtonById" onClick={handleSortByIdReverse}>
          Sort By ID ↑
        </Button>
        <Button className="sortButtonByType" onClick={handleSortByType}>
          Sort By Type
        </Button>
      </div>
      <div className="bigDiv">{shopComponents}</div>
      <Copyright />
    </>
  );
}
